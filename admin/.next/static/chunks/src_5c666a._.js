...
function ManageEventOrganizer() {
    ...
    const handleConfirmToggle = ()=>{
        if (!selectedOrganierEvent || !selectedOrganierEvent._id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Invalid organizer ID");
            return;
        }
        setLoading(true);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$organizer$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveInActiveOrganizerApi"])({
            ...
            if (res?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res?.message || "Status updated successfully");
                fetchGetAllOrganizer(params);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to update status");
            }
            setIsModalOpen(false);
            setSelectedOrganierEvent(null);
        }).catch((error)=>{
            setLoading(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error updating organizer status");
            setIsModalOpen(false);
            setSelectedOrganierEvent(null);
        });
    };
    ...
    const handleConfirmSuspend = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$organizer$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveInActiveOrganizerApi"])({
            ...
            setLoading(false);
            if (res?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res?.message || (isSuspended ? "Host suspended successfully" : "Host unsuspended successfully"));
                fetchGetAllOrganizer(params);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to update suspend status");
            }
            setSuspendModalOpen(false);
            setSelectedOrganizerForSuspend(null);
        }).catch((error)=>{
            setLoading(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error updating suspend status");
            setSuspendModalOpen(false);
            setSelectedOrganizerForSuspend(null);
        });
    };
    ...
    const ChangeStatus = (organizerId, newStatus)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$organizer$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChangeStatusOrganizerApi"])(data).then((res)=>{
            ...
            setLoading(false);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to change status");
        });
    };
...
_s(ManageEventOrganizer, "h3Gf3jYtxpa6HeLgzYmNXnp9ugc=", false, function() {
    return [
