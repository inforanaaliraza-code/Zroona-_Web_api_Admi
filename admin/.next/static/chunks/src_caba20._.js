(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_caba20._.js", {
...
function UserDetail() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (id) {
            ...
            fetchUserDetail({
                ...
                setLoading(false);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to fetch User details");
            });
        }
    }, [
        id,
    ...
    const handleConfirmSuspend = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveInActiveUserApi"])({
            ...
            if (res?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res?.message || "Account suspended successfully");
                fetchUserDetail({
                    id: id
                });
                setSuspendModalOpen(false);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to suspend account");
            }
        }).catch((err)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to suspend account");
        }).finally(()=>{
            setLoading(false);
            setSuspendModalOpen(false);
        });
    ...
    const handleActivate = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ActiveInActiveUserApi"])({
            ...
            if (res?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res?.message || "Account activated successfully");
                fetchUserDetail({
                    id: id
                });
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to activate account");
            }
        }).catch((err)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to activate account");
    ...
    const handleDelete = ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeleteUserApi"])({
            ...
            if (res?.status === 1 || res?.code === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Account deleted successfully");
                router.push("/user");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to delete account");
            }
        }).catch((err)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete account");
        }).finally(()=>setLoading(false));
    };
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                onClick: ()=>{
                                                                    ...
                                                                    if (ratingSection) {
                                                                        ...
                                                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info("Rating information will be displayed here");
                                                                    }
                                                                },
...
_s(UserDetail, "c8pm+PD0pGdRWq1vs4exN9R9Lww=", false, function() {
    return [
...
//# sourceMappingURL=src_caba20._.js.map