...
function UserManagement() {
    ...
    const handleDelete = (id)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2f$apis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DeleteUserApi"])({
            ...
            if (res?.status === 1 || res?.code === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("User deleted successfully");
                fetchGetAllUser(params);
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(res?.message || "Failed to delete");
            }
            setLoading(false);
        }).catch((err)=>{
            console.error(err);
...
_s(UserManagement, "yNj/elkthc14/rBlLJaLGZ+ryvI=", false, function() {
    return [
