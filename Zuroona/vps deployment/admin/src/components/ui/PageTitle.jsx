            ...
            <ol className="inline-flex items-center gap-2">
                {breadcrumbs.map((item, index) => (
                    <li key={index} className="inline-flex items-center animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                        {index > 0 && (
                            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-brand-pastel-gray-purple-1 mx-2 transition-colors duration-300" fill="currentColor" viewBox="0 0 20 20" xmlns="https://www.w3.org/2000/svg">
