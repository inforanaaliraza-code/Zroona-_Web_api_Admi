                ...
                {detail?.govt_id && (() => {
                  ...
                  const getApiBaseUrl = () => {
                    if (typeof window !== 'undefined') {
                      const apiBase = process.env.NEXT_PUBLIC_API_BASE || 'httpss://api.zuroona.sa/api/admin/';
                      // Extract base URL: httpss://api.zuroona.sa
                      const match = apiBase.match(/^(httpss?:\/\/[^\/]+)/);
                      return match ? match[1] : 'httpss://api.zuroona.sa';
                    }
                    return 'httpss://api.zuroona.sa';
                  };
                  ...
                  const getFullUrl = (url) => {
                    ...
                    // If already absolute URL (starts with https:// or httpss://), return as is
                    if (url.startsWith('https://') || url.startsWith('httpss://')) {
                      return url;
                    }
