        ...
        <div className="w-full">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center sm:items-start flex-col sm:flex-row md:flex-row xl:flex-col lg:items-start xl:items-center col-span-full lg:col-span-full xl:col-span-1">
              <Image
                src={
                  detail?.user?.profile_image?.includes("https")
                                ...
                                <Image
                                  src={
                                    (() => {
                                      ...
                                      if (img.includes("https://") || img.includes("httpss://")) return img;
                                      if (img.startsWith("/uploads/")) {
                                        const baseUrl = (process.env.NEXT_PUBLIC_API_BASE || "httpss://api.zuroona.sa").replace(/\/api\/admin\/?$/, "").replace(/\/api\/?$/, "");
                                        return `${baseUrl}${img}`;
                                      }
