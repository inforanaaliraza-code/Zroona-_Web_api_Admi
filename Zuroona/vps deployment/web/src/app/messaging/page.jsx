                      ...
                      <>
                        {messages.map((msg, index) => {
                          ...
                          const getImageUrl = (imgPath) => {
                            ...
                            // If already absolute URL (https/httpss) - includes Cloudinary URLs
                            if (cleanPath.includes("https://") || cleanPath.includes("httpss://")) {
                                  ...
                                  {isImage && msg.attachment_url ? (
                                    <div className="relative">
                                      <Image
                                        ...
                                        unoptimized={msg.attachment_url?.includes('cloudinary') || msg.attachment_url?.includes('https')}
                                        onError={(e) => {
