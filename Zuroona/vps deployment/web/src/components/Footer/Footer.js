                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
                    ...
                    <div className="gap-y-4">
                        ...
                        <div className="flex gap-4 pt-4 flex-wrap">
                            <a 
                                href="httpss://www.instagram.com/zuroona?igsh=MXJvN2s4ZHlvNGR3aQ%3D%3D&utm_source=qr" 
                            ...
                            <a 
                                href="httpss://x.com/zuroonaksa?s=11&t=cwvlmHDPVC7mbsMLpqJFkQ" 
                                className="text-gray-400 hover:text-brand-orange transition-colors" 
                                target="_blank" 
                                rel="noopener noreferrer"
                            ...
                            <a 
                                href="httpss://www.tiktok.com/@zuroona?_t=ZN-90tyaX4DPnS&_r=1" 
                                className="text-gray-400 hover:text-brand-orange transition-colors" 
                                target="_blank" 
                                rel="noopener noreferrer"
                            ...
                            <a 
                                href="httpss://snapchat.com/t/IQxxW6dK" 
                                className="text-gray-400 hover:text-brand-orange transition-colors" 
                                target="_blank" 
                                rel="noopener noreferrer"
                            ...
                            <a 
                                href="httpss://www.facebook.com/share/1DbUJBjatB/?mibextid=wwXIfr" 
                                className="text-gray-400 hover:text-brand-orange transition-colors" 
                                target="_blank" 
                                rel="noopener noreferrer"
