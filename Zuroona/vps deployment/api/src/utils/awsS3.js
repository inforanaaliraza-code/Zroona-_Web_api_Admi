...
const uploadToS3 = async (fileBuffer, folder = 'Zuroona', fileName = null, mimeType = 'image/jpeg') => {
    try {
        ...
        // Format: httpss://bucket-name.s3.region.amazonaws.com/key
        const url = `httpss://${bucketName}.s3.${region}.amazonaws.com/${key}`;
...
const extractKey = (url) => {
    ...
    // Example: httpss://bucket-name.s3.region.amazonaws.com/folder/file.jpg
