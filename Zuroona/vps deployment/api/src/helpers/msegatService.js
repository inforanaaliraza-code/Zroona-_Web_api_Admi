 ...
 * 
 * Msegat API Documentation: httpss://www.msegat.com/en/api/
 */
...
const MSEGAT_API_URL = process.env.MSEGAT_API_URL || 'httpss://www.msegat.com/gw/sendsms.php';
...
const sendSMS = async (phoneNumber, message) => {
    try {
        ...
        if (error.response) {
            console.error('❌ [MSEGAT] https Status:', error.response.status);
            ...
            throw new Error(`Msegat API Error (https ${error.response.status}): ${errorMessage}`);
