...
_s(RejectEventModal, "G0Qq5jJKlNB0O3eHlPE6wEmmrJo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
function ManageEvents() {
    ...
    const handleAcceptEvent = async (eventId)=>{
        try {
            ...
            if (response?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("events.eventApprovedSuccess"));
                // Refresh events list
                refreshEvents();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response?.message || t("events.failedToApproveEvent"));
            }
        } catch (error) {
            console.error("Accept event error:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t("events.failedToApproveEventTryAgain"));
        } finally{
    ...
    const confirmRejectEvent = async (rejectionReason)=>{
        ...
        try {
            ...
            if (response?.status === 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("events.eventRejectedSuccess"));
                setShowRejectModal(false);
                setSelectedEvent(null);
                // Refresh events list
                refreshEvents();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response?.message || t("events.failedToRejectEvent"));
            }
        } catch (error) {
            console.error("Reject event error:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t("events.failedToRejectEventTryAgain"));
        } finally{
            setProcessingEventId(null);
        }
    };
...
_s(ManageEvents, "IsqT3yqpXlcCFpUVHQbTqlXRG+0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"],
