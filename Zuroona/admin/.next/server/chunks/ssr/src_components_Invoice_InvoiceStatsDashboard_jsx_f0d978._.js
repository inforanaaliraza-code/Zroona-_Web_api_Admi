...
const registerChart = ()=>{
    if (typeof window !== 'undefined' && !chartRegistered) {
        __turbopack_require__("[project]/node_modules/chart.js/dist/chart.js [app-ssr] (ecmascript, async loader) <facade>")(__turbopack_import__).then(({ Chart: ChartJS, CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend })=>{
            ChartJS.register(CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend);
            chartRegistered = true;
        });
    }
};
const InvoiceStatsDashboard = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$future$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(()=>{
        ...
        try {
            ...
            if (res && (res.status === 1 || res.code === 200)) {
                if (res.data) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].warning(t('invoice.stats.noData'));
                }
            } else if (res) {
...
//# sourceMappingURL=src_components_Invoice_InvoiceStatsDashboard_jsx_f0d978._.js.map