      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-900">
            {isSuspended ? t("common.activateGuest") : t("common.suspendGuest")}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          <p className="text-gray-700 mb-4">
            {isSuspended 
              ? t("common.activateConfirm", { name: `${user?.first_name} ${user?.last_name}` })
              : t("common.suspendConfirm", { name: `${user?.first_name} ${user?.last_name}` })
            }
          </p>
          ...
          {!isSuspended && (
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-purple-800 mb-2">
                <strong>{t("common.important")}:</strong> {t("common.suspendNotification", { type: t("common.guest") })}
              </p>
