...
export default function RTLHandler() {
  ...
  useEffect(() => {
    ...
    const updateRTL = () => {
      ...
      // On client: prefer localStorage (user's choice). i18n starts as "en" for hydration.
      const lang = (typeof localStorage !== "undefined" ? localStorage.getItem("i18nextLng") : null) ||
                   i18n.language || 
                   "en";
